...
#Purpose: Contains Functions for calculating Burn Severity Classification using USGS landsat TM 5,7,8
#Requirements: Landsat.py, ESRI ArcGIS 10.1 ArcInfo, ESRI Spatial Analyst extention
#Inputs:
...
def get_transformation_default(from_sr, to_sr):
    ...
    transformation_dict = {'NAD_1983_BC_Environment_Albers':'NAD_1983', 'BCAlbers83': 'NAD_1983', \
                           ...
                           'WGS_1984_UTM_Zone_7N': 'WGS_1984', 'WGS_1984_UTM_zone_8N': 'WGS_1984', 'WGS_1984_UTM_zone_7N': 'WGS_1984'}
